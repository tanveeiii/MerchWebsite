    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-orange-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white p-8 rounded-3xl shadow-2xl w-full max-w-md border border-orange-200 backdrop-blur-sm z-10">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center h-16 w-16 bg-gradient-to-r from-orange-500 via-pink-500 to-orange-500 rounded-full mb-4 shadow-lg">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="no-spinner w-full p-4 pl-12 rounded-xl bg-white text-gray-900 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent placeholder-gray-400 backdrop-blur-sm text-center text-lg tracking-widest"
              />
        ...
        <div className="mt-8 text-center">
          {timeLeft > 0 ? (
            <span className="text-gray-600 text-sm">
              Didn't get the code?{" "}
              <span className="text-orange-400 font-semibold opacity-60 cursor-not-allowed select-none">
