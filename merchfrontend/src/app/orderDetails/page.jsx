      ...
      <div className="mt-10 w-9/12 font-[Poppins] bg-slate-100 h-[70vh] mx-auto rounded-md">
        ...
        <div className="h-[30vh] border-[#8080802e] m-4 mt-4 rounded-md border-2 flex flex-row bg-white justify-between">
          <div className="flex flex-row">
            <img
              src="https://images.pexels.com/photos/7679454/pexels-photo-7679454.jpeg?auto=compress&cs=tinysrgb&w=400"
            ...
            <div className="flex flex-col  justify-around py-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button className=" text-white bg-slate-400 rounded-2xl px-2 py-1 cursor-pointer h-10">
                  Buy again
                </button>
                <button className=" text-white bg-slate-400 rounded-2xl px-2 py-1 cursor-pointer ">
                  View item
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-5 m-9">
            <button className=" text-black border-black border-2 bg-white rounded-2xl px-2 py-1 cursor-pointer h-10">
