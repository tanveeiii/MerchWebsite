    ...
    <div className="px-6 py-10 max-w-7xl mx-auto">
      ...
      <section className="w-full flex flex-col text-center items-center">
        <h2 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight">
          Shop Vibrant <span className="text-blue-600">Custom</span> <br />{" "}
          t-shirt designs
        </h2>
        <p className="text-gray-500 mb-10 text-lg max-w-2xl">
        ...
        <div className="flex gap-4 flex-col sm:flex-row">
          ...
          <button className="px-6 py-3 border border-gray-400 rounded-lg font-medium hover:bg-gray-100 transition">
            Customize t-shirt
          </button>
        </div>
      </section>
