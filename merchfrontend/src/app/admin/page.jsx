  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard title="Total Orders" value="154" icon={<ShoppingBag size={24} />} color="bg-blue-500" />
        <StatCard title="Total Products" value="45" icon={<Package size={24} />} color="bg-orange-500" />
        <StatCard title="Active Users" value="1,203" icon={<Users size={24} />} color="bg-purple-500" />
      </div>
