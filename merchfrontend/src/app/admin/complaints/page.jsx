...
export default function AdminComplaints() {
  ...
  const handleResolve = async (id) => {
    ...
    if (!text) return CustomToast("Please enter a reply message.");
    ...
    try {
      ...
      if (res.ok) {
        CustomToast("Complaint Resolved!");
        ...
        CustomToast("Failed to send reply.");
      }
    } catch (e) {
      console.error(e);
