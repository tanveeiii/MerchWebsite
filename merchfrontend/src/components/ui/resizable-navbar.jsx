...
export const NavBody = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] hidden w-full flex-row items-center justify-between self-start rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent mx-auto",
